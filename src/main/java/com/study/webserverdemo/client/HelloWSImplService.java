 ...
 * 
 */
@WebServiceClient(name = "HelloWSImplService", targetNamespace = "http://ws.webserverdemo.study.com/", wsdlLocation = "http://localhost:9999/test/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWSIMPLSERVICE_QNAME = new QName("http://ws.webserverdemo.study.com/", "HelloWSImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9999/test/hello?wsdl");
    ...
    public com.study.webserverdemo.client.HelloWS getHelloWSImplPort() {
        return super.getPort(new QName("http://ws.webserverdemo.study.com/", "HelloWSImplPort"), com.study.webserverdemo.client.HelloWS.class);
    }
     ...
     */
    @WebEndpoint(name = "HelloWSImplPort")
    public com.study.webserverdemo.client.HelloWS getHelloWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.webserverdemo.study.com/", "HelloWSImplPort"), HelloWS.class, features);
    }
